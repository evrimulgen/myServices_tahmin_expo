...
export const logoutUser = ({ token }) => {
  return (dispatch) => {
    ...
    axios.get(`${allowed_host}/v1/users/logout/`,
...
export const userGetMe = ({ token }) => {
  ...
  return (dispatch) => {
    ...
    axios.get(`${allowed_host}/v1/users/me/`, {
      headers: 
      { 
...
export const userDeleteMe = ({ token }) => {
  ...
  return (dispatch) => {
    ...
    axios.delete(`${allowed_host}/v1/users/me/`, { 
      headers: 
      { 
        Authorization: `Token ${token}`
      }
...
export const userUpdateMe = ({ token, username=null, password=null, email=null, first_name=null, last_name=null, bio=null , profile_photo=null }) => {
  ...
  return (dispatch) => {
    ...
    axios.patch(`${allowed_host}/v1/users/me/`,
      {
      "username": username,
      //"password": password,
      "email": email,
...
export const getAnotherUser = ( user_id, { token } ) => {
  ...
  return (dispatch) => {
    axios.get(`${allowed_host}/v1/users/${user_id}/`, { 
      headers: 
      { 
        Authorization: `Token ${token}`
      }
...
export const userChangePassword = ({ old_password, new_password, token }) => {
  ...
  return (dispatch) => {
    ...
    axios.patch(`${allowed_host}/v1/users/me/password/`, { 
      headers: 
      {
        Authorization: `Token ${token}`,
...
export const followUser = (user_id, { token }) => {
  ...
  return (dispatch) => {
    ...
    axios.post(`${allowed_host}/v1/users/${user_id}/follow/`, { 
      headers: 
      { 
        Authorization: `Token ${token}`
      }
...
export const unfollowUser = (user_id, { token }) => {
  ...
  return (dispatch) => {
    ...
    axios.post(`${allowed_host}/v1/users/${user_id}/unfollow/`, { 
      headers: 
      { 
        Authorization: `Token ${token}`
      }
...
export const userVerify = ({ verification_key }) => {
  ...
  return (dispatch) => {
    ...
    axios.get(`${allowed_host}/v1/users/activate/?key=:${verification_key}`)
      .then(() => {
...
export const requestPasswordReset = (user_identifier) => {
  ...
  return (dispatch) => {
    axios.post(`${allowed_host}/v1/users/forgot_password/`, { 
...
export const changePasswordWithKey = ({ key, password }) => {
  ...
  return (dispatch) => {
    ...
    axios.post(`${allowed_host}/v1/users/change_password/`, { 
      headers:
      { 
        key: key,
        password: password
...
export const getUserTrophies = () => {
  ...
  return (dispatch) => {
    axios.get(`${allowed_host}/v1/users/me/trophies`)
      .then(response => {
        console.log(response.data),
        dispatch({
...
export const getAnotherUserTrophies = (user_id) => {
  ...
  // Response: 200 and list of Trophy objects
  return (dispatch) => {
    axios.get(`${allowed_host}/v1/users/${user_id}/trophies`)
      .then(response => {
        dispatch({
...
export const getUserTrophyProgress = ({ token }) => {
  ...
  return (dispatch) => {
    ...
    axios.get(`${allowed_host}/v1/uesrs/me/progression`, { 
      headers: 
      { 
        Authorization: `Token ${token}`
      }
...
export const getUserFeed = ({ token }) => {
  ...
  return (dispatch) => {
    ...
    axios.get(`${allowed_host}/v1/users/feed/`, { 
      headers: 
      { 
        // Authorization: `Token ${token}`
